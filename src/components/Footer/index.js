    ...
    <div className={styles.footer}>
      <div className={styles.flexer}>
        <div className={styles.footer_left}>
          ...
          <p className={styles.subtext}>Full Stack Developer</p>
          ...
          <p className={styles.copyright}>
            Copyright &copy; 2021 attaboyabhilash.com, <br /> All Rights
            Reserved.
          </p>
          <div className="icons">
            <a
            ...
            <a target="_blank" href="https://twitter.com/attaboyabhilash">
              <FaTwitter className={styles.twitter} />
            </a>
            <a target="_blank" href="https://github.com/attaboyabhilash">
